...
import com.ljs.miaosha.util.RedisConcurrentTestUtil;
...
public class DemoController {
	...
	@RequestMapping("/redis/deletebyid")
	@ResponseBody
	public Result<Boolean> redisDeleteById() {//0代表成功		
		Boolean res=redisService.delete(UserKey.getById,""+1);
		//redisService.get("key1",String.class);
		//System.out.println("res:"+userService.tx());
		return Result.success(res);
	}
	...
	@ResponseBody
	public Result<Long> redisIncr() {//0代表成功		
		//User user=new User(1,"1112");
		System.out.println("redisSet:");
		long f=redisService.incr(UserKey.getById,""+2);
	...
	@ResponseBody
	public Result<Boolean> redistestConcurrent() {//0代表成功		
		//User user=new User(1,"1112");
